    ...
    <div className="markdown-editor" style={{ border: '1px solid #334155', borderRadius: 6, overflow: 'hidden' }}>
      <div style={{ display: 'flex', gap: 0, borderBottom: '1px solid #334155', background: '#1e293b' }}>
        <button
          ...
          style={{
            padding: '0.4rem 1rem',
            border: 'none',
            background: tab === 'edit' ? '#0f172a' : 'transparent',
            color: tab === 'edit' ? '#e2e8f0' : '#64748b',
            cursor: 'pointer',
            fontSize: '0.85rem',
        ...
        <button
          ...
          style={{
            padding: '0.4rem 1rem',
            border: 'none',
            background: tab === 'preview' ? '#0f172a' : 'transparent',
            color: tab === 'preview' ? '#e2e8f0' : '#64748b',
            cursor: 'pointer',
            fontSize: '0.85rem',
      ...
      {tab === 'edit' ? (
        <textarea
          ...
          style={{ minHeight, width: '100%', border: 'none', borderRadius: 0, resize: 'vertical', fontFamily: 'inherit' }}
        />
      ) : (
        <div style={{ padding: '0.75rem', minHeight, overflow: 'auto', background: '#0f172a' }}>
          {value ? (
            ...
            <span style={{ color: '#64748b', fontSize: '0.85rem' }}>暂无内容</span>
          )}
        </div>
      )}
    </div>
